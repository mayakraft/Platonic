...
// helper function for platonic.h
...
void display(){
	...
	mouseTotalOffsetX += 1.66;
	if(mouseTotalOffsetX % 180 < 180/5.0)   selected_solid = 0;
	else if(mouseTotalOffsetX % 180 < 180/5.0 * 2)   selected_solid = 1;
	else if(mouseTotalOffsetX % 180 < 180/5.0 * 3)   selected_solid = 2;
	else if(mouseTotalOffsetX % 180 < 180/5.0 * 4)   selected_solid = 3;
	else   selected_solid = 4;

	if(((int)(mouseTotalOffsetX / 180.0)) % 2)
		seeThrough = 1;
	else
		seeThrough = 0;
